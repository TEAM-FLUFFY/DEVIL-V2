class script(object):
    START_TXT = """𝙷𝙴𝚈 {},
𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 , <a href='https://t.me/Rocky_Bhaikgfbot'>𝖠𝖧 𝖱𝖮𝖢𝖪𝖸 𝖡𝖧𝖠𝖨</a>, 𝙸 𝙲𝙰𝙽 𝙿𝚁𝙾𝚅𝙸𝙳𝙴 𝙰 𝙼𝙾𝚅𝙸𝙴 𝙹𝚄𝚂𝚃 𝙰𝙳𝙳 𝙼𝙴 𝚃𝙾 𝙰 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙰𝙽𝙳 𝙼𝙰𝙺𝙴 𝙼𝙴 𝚂𝚄𝚁𝙴 𝙰𝙳𝙼𝙸𝙽 𝚃𝙷𝙴𝙽 𝚂𝙴𝙴 𝙼𝚈 𝙿𝙾𝚆𝙴𝚁𝚂... ❤️
"""
    HELP_TXT = """𝙷𝙴𝚈 {}
