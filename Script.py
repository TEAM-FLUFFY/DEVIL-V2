class script(object):
    START_TXT = """ℍ𝔼𝕃𝕃𝕆 {},
𝕄𝕐 jℕ𝔸𝕄𝔼 𝕀𝕊 <a href=https://t.me/{}>{}</a>, 𝕀 ℂ𝔸ℕ  ℙℝ𝕆𝕍𝕀𝔻𝔼 𝕄𝕆𝕍𝕀𝔼𝕊 , 𝕁𝕌𝕊𝕋 𝔸𝔻𝔻 𝕄𝔼 𝕋𝕆 𝕐𝕆𝕌ℝ 𝔾ℝ𝕆𝕌ℙ 𝔸ℕ𝔻 𝕄𝔸𝕂𝔼 𝕄𝔼 𝔸𝔻𝕄𝕀ℕ.. 𝕋ℍ𝔼ℕ 𝕊𝔼𝔼 𝕄𝕐 ℙ𝕆𝕎𝔼ℝ𝕊..  ❗❗"""
"""
    HELP_TXT = """𝙷𝙴𝚈 {}
...
╔════❰ 𝙵𝙻𝚄𝙵𝙵𝚈 ❱═❍⊱❁۪۪
║╭━━━━━━━━━━━━━━━➣ 
║┣⪼ 𝙼𝚈 𝙽𝙰𝙼𝙴 - <a href="https://t.me/Ramananshav3_bot">ℝ𝔸𝕄𝔸ℕ𝔸ℕ</a>
║┣⪼ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁- <a href="https://t.me/TEAM_KERALA">ℙ𝔼𝕋𝔼ℝ ℙ𝔸ℝ𝕂𝔼ℝ</a>
 ┣⪼ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁- <a href="https://t.me/TEAM_KERALA">ℙ𝔼𝕋𝔼ℝ ℙ𝔸ℝ𝕂𝔼ℝ</a>
║┣⪼ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈 - 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
║┣⪼ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴 - 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
║┣⪼ 𝙳𝙰𝚃𝙰𝙱𝙰𝚂𝙴 - 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
